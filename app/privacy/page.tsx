      ...
      <section className="flex w-full max-w-7xl flex-col gap-6 text-lg text-foreground/80">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col">
            ...
            <span>
              ...
              <a href="https://rivo.gg">https://rivo.gg</a> or{" "}
            </span>
            <span>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col">
            ...
            <span>
              ...
              website operated by Rivo or any third party;
            </span>
            <span>or</span>
            <span>
            ...
            <span>
              ...
              practices regarding your information and how we treat it. If you
              do not agree with our policies and practices, your choice is not
              to use our website or bot. By accessing or using this website/bot,
              ...
              policy every once in a while for updates.
            </span>
          </div>
        </div>
        <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-4">
          ...
          <span>
            ...
            to view our website. Rivo only gathers personally identifiable data
            through our website, such as an email address, when voluntarily
            submitted by a visitor. Once collected, we may combine this
            information with other information collected from external sources.
          </span>
          ...
          <span>
            ...
            linked website by Rivo. If you provide any personal data through any
            such third-party website, your transaction will occur on the third
            ...
            that third party. We recommend that you familiarize yourself with
            the privacy policies and practices of any third parties. Please note
            that this privacy policy does not address the privacy or Information
        ...
        <div className="flex flex-col gap-4">
          ...
          <span>
            ...
            investigate problems or enforce our Terms of Service. At times, we
            may review status or activity of multiple users to do so. We may
            disclose or access information whenever we believe in good faith
            that the law so requires or if we otherwise consider it necessary to
            do so to maintain service and improve our services. We use your IP
            address to help diagnose problems with our server, to manage our
            website and to enhance our site based on the usage pattern we
            receive.
          </span>
          <div>
            ...
            <span>
              ...
              have a registered account with the Website, you have the right to
              request removal of unwanted data that you publicly post on the
              Website. To request removal of such data, please contact us using
              ...
              displayed on the Website, but please be aware that the data may
        ...
        <div className="flex flex-col gap-4">
          ...
          <span>
            ...
            please visit: <a href="mailto:dominik@rivo.gg">dominik@rivo.gg</a>.
          </span>
        </div>
      </section>
    </main>
