...
export const metadata: Metadata = {
	title: "Would You - Privacy Policy",
};
			...
			<section className="flex w-full max-w-7xl flex-col gap-6 text-lg text-foreground/80">
				...
				<div className="flex flex-col gap-4">
					...
					<div className="flex flex-col">
						<span>This privacy notice describes how we might use your information if you:</span>
						<span>
							- Visit our website at <a href="https://rivo.gg">https://rivo.gg</a> or{" "}
						</span>
				...
				<div className="flex flex-col gap-4">
					...
					<span>
						We respect the privacy of your information. We provide this explanation about our information practices as a
						show of our commitment to protect your privacy. This policy describes the types of information we may
						collect from you or that you may provide when you visit this website and our practices for collecting,
					...
					<div className="flex flex-col">
						...
						<span>
							- Data about your discord server including your server id, avatar, settings, webhook urls, custom uploaded
							messages and
						</span>
						<span>
							- If and when available, through mobile or desktop applications you download from this website, which
							provide dedicated non-browser- based interaction between you and this website.
						</span>
						<span>
							- When you interact with our applications on social media or third-party applications, websites and
							services, if those applications or advertising including links to this policy or of information from
							social media or third parties.
						</span>
					</div>
					<div className="flex flex-col">
						<span>It does not apply to information collected by:</span>
						<span>
							- us offline or through any other means, including on any other website operated by Rivo or any third
							party;
						</span>
						<span>or</span>
						<span>
						...
						<span>
							...
							how we treat it. If you do not agree with our policies and practices, your choice is not to use our
							website or bot. By accessing or using this website/bot, you agree to this privacy policy. This policy may
							change from time to time. Your continued use of this website after we make changes is deemed to be
							acceptance of those changes, so please check the policy every once in a while for updates.
						</span>
					</div>
				</div>
				<div className="flex flex-col gap-4">
					...
					<span>
						In some regions (like the PEA and UK), you have certain rights under applicable data protection laws. These
						may include the right (i) to request access and obtain a copy of your personal information, (ii) to request
						rectification or erasure; (Hi) to restrict the processing of your personal information; and (iv) If
						applicable, to data portability. In certain circumstances, you may also have the right to object to the
						processing of your personal Inform. To make such a request please use the contact details provided below. We
						will consider and act upon any request in accordance with applicable data protection laws. If we are relying
						on your consent to process your personal information, you have the right to withdraw your consent at any
						...
						grounds other than consent. If you are a resident in the EEA or UK and you believe we are unlawfully
						...
						available here:{" "}
						<a href="https://www.edoeb.admin.ch/edoebtenfhome.html" target="_blank" rel="noopener noreferrer">
				...
				<div className="flex flex-col gap-4">
					...
					<span>
						...
						marketing outreach. We chose Plausible Analytics because it is a privacy-focused company and platform that
						eschews personally identifiable information in favor of anonymous aggregate data. We do not use Plausible
						Analytics to track or collect any personally identifiable information about you. Plausible is self-hosted
						and does not use cookies nor store any personal information.{" "}
				...
				<div className="flex flex-col gap-4">
					...
					<span>
						This website or messages distributed by our bot may contain links to third-party websites. These linked
						websites are not under our control, and we are not responsible for the privacy practices or the contents of
						any such linked website or any link contained in any linked website. We provide such links only as a
						convenience, and the inclusion of a link on the website does not imply endorsement of the linked website by
						Rivo. If you provide any personal data through any such third-party website, your transaction will occur on
						the third party&apos;s website (not this website) and the personal data you provide will be collected by and
						controlled by the privacy policy of that third party. We recommend that you familiarize yourself with the
						privacy policies and practices of any third parties. Please note that this privacy policy does not address
						the privacy or Information practices of any third party website or tool.
					</span>
				</div>
				<div className="flex flex-col gap-4">
					...
					<div className="flex flex-col">
						<span>
							This Privacy Statement governs use of the information that you provide to us through the website or bot.
							It does not govern the manner in which we may use information obtained from other sources (such as public
							records) or from you by means other than this website. We and other entities that we are involved in, or
							provide support for, the operation of this website or other purposes use information that we collect about
							you or that you provide to us, including any personal information:
						</span>
						<span>- To present our website and its contents to you.</span>
						<span>- To provide you with information on programs, services or products.</span>
						<span>- For you to register for events, promotions, contests, sweepstakes or services.</span>
						<span>
							- To process online transactions, purchases, registrations, donations or participation in programs.
						</span>
						<span>- To provide you with information that may be targeted to your interests.</span>
						...
						<span>- To request additional information from you for various purposes.</span>
						<span>- In any other way we may describe when you provide the information.</span>
						<span>
							- For any other purpose with your consent. We may also use your information if provided to us to contact
							you about our own and third-party services and products that may be of interest to you. If you do not want
							us to use your information in this way, you can opt out of receiving this information by so indicating in
							your registration/preferences file or by notifying us.
						</span>
					</div>
					<span>
						We may also use or disclose information to resolve disputes, investigate problems or enforce our Terms of
						Service. At times, we may review status or activity of multiple users to do so. We may disclose or access
						information whenever we believe in good faith that the law so requires or if we otherwise consider it
						necessary to do so to maintain service and improve our services. We use your IP address to help diagnose
						problems with our server, to manage our website and to enhance our site based on the usage pattern we
						receive.
					</span>
					<div>
						<h6>Do California residents have specific privacy rights?</h6>
						<span>
							...
							below. If you are under 18 years of age, reside in California, and have a registered account with the
							Website, you have the right to request removal of unwanted data that you publicly post on the Website. To
