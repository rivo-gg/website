    ...
    <main className="legals">
      <section className="flex w-full max-w-7xl flex-col gap-6 text-lg text-foreground/80">
        ...
        <div className="flex flex-col gap-4">
          ...
          <span>
            These terms of service (the &quot;Terms&quot;) apply to the Rivo
            Discord bot. By using Rivo, you agree to be bound by these Terms and
            any additional terms that may be provided by the Company. If you do
            not agree to these Terms, you may not use Rivo.
          </span>
          <span>
            Rivo is a bot for the chat and social platform &quot;Discord&quot;
            (accessible at{' '}
            <Link
            ...
            , including its Terms of Service and Privacy Policy). Rivo is
        ...
        <div className="flex flex-col gap-4">
          ...
          <span>
            The Rivo Bot is not intended for use by individuals under the age of
            13. By using the Rivo Bot, you represent and warrant that you are at
            least 13 years of age. If you are under 13 years of age, you are not
            permitted to use the Rivo Bot. If we become aware that a user is
            under the age of 13, we will take steps to terminate their access to
            the Rivo Bot and delete any personal information collected from
            them, if applicable.
          </span>
        </div>
        <div className="flex flex-col gap-4">
          ...
          <span>
            The Rivo discord Bot offers a premium subscription model
        ...
        <div className="flex flex-col gap-4">
          ...
          <span>
            ...
            Stripe. By subscribing to the Premium Model, you authorise the
            Creator to automatically charge the applicable subscription fee to
        ...
        <div className="flex flex-col gap-4">
          ...
          <span>
            Rivo and all content and software associated with the bot, including
            but not limited to text, graphics, logos, and images, are the
            property of the Company and are protected by copyright and other
        ...
        <div className="flex flex-col gap-4">
          ...
          <span>
            1. The bot may experience downtime, errors, or technical issues
            beyond our control. We do not accept responsibility for any
            inconvenience, loss of data, or damages resulting from the use of
            this bot.
          </span>
          <span>
        ...
        <div className="flex flex-col gap-4">
          ...
          <span>
            These Terms and your use of Rivo will be governed by and construed
            in accordance with the laws of Germany. Any dispute arising out of
            or in connection with these Terms or Rivo will be resolved through
            ...
            against you if you attack or harm our services. You agree that we
            may use any data collected for the purpose of taking action to
            exclude you from the Service.
          </span>
        </div>
        <div className="flex flex-col gap-4">
          <h4>11. Disclaimer</h4>
          <span>
            Rivo is provided &quot;as is&quot; and &quot;as available&quot;, and
            the Company makes no warranties of any kind, express or implied,
            including but not limited to warranties of merchantability, fitness
            for a particular purpose, and non-infringement. The Company does not
            guarantee that Rivo will be available at all times or that it will
            be error-free. In no event shall we be liable for any damages
        ...
        <div className="flex flex-col gap-4">
          ...
          <span>
            ...
            damages arising out of or in connection with your use of Rivo,
