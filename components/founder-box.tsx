        ...
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="flex-1">
              <a href="https://dominikkoch.dev/" target="_blank" rel="noreferrer">
                <h3 className="text-3xl font-semibold mb-4 text-primary">
                  Dominik Koch
                </h3>
              </a>
              <p className="text-lg mb-6">
                Hi, I'm Dominik Koch the founder of{" "}
                <span className="text-primary">Rivo</span>. I love working on
                modern solutions to all sorts of problems. I'm a creative
                thinker, problem solver, and tech enthusiast. I'm always looking
              ...
              <p className="text-lg mb-6">
                ...
                <a href="mailto:dominik@rivo.gg">
                  <code className="text-blue-500 hover:text-blue-400">
                    dominik@rivo.gg
                  </code>
                </a>
                !
              ...
              <ul className="space-y-2 mb-6">
                {["Problem Solver", "Tech Enthusiast", "Creative Thinker"].map(
                  (skill) => (
