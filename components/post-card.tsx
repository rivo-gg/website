	...
	return (
		<li className="flex flex-col gap-4">
			...
			<div className="flex flex-col gap-2">
				<Link href={link} className="hover:text-muted-foreground transition duration-300">
					<h2 className="text-3xl text-foreground hover:text-muted-foreground transition">{post.title}</h2>
				</Link>
				...
				<div className="flex items-center justify-between mt-4">
					...
					<p className="text-muted-foreground text-sm">{calculateReadTime(post.content)} min read</p>
