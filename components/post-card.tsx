					...
					<div className="flex items-center gap-2 p-4">
						...
						<div className="flex flex-col text-xs">
							...
							<div className="flex items-center gap-2">
								<time className="text-muted-foreground" dateTime={post.publishedAt.toString()}>
									{formattedDate}
								</time>
								<span className="text-muted-foreground">•</span>
								<p className="text-muted-foreground text-xs">{calculateReadTime(post.content)} min read</p>
							</div>
						</div>
					</div>
				</div>
